...
<div id="comments" class="comments-area">
	...
	<?php if ( have_comments() ) : ?>
		...
		<nav id="comment-nav-above" class="navigation comment-navigation">
			<h2 class="screen-reader-text"><?php esc_html_e( 'Comment navigation', 'krea' ); ?></h2>
			<div class="nav-links">

				<div class="nav-previous"><?php previous_comments_link( esc_html__( 'Older Comments', 'krea' ) ); ?></div>
				<div class="nav-next"><?php next_comments_link( esc_html__( 'Newer Comments', 'krea' ) ); ?></div>
	...
	?>
		<p class="no-comments"><?php esc_html_e( 'Comments are closed.', 'krea' ); ?></p>
	<?php endif; ?>
	...
	$comments_args = array(
	        ...
	        'comment_field' => '<div class="clearfix"></div><div class="input-wrap textarea">
							      <label class="control-label" for="comment">'. esc_html__( 'Comment', 'krea' ) .'</label>
			...
			'fields' => apply_filters( 'comment_form_default_fields', array(
						...
						'author' =>	'<div class="input-wrap">
								      <label class="control-label" for="author">'. esc_html__( 'Name', 'krea' ) . '' . ( $req ? ' (*)' : '' ).'</label>
								      <div class="controls-wrap">
						...
						'email' =>	'<div class="input-wrap">
								      <label class="control-label" for="email">'. esc_html__( 'Email', 'krea' ) . '' . ( $req ? ' (*)' : '' ).'</label>
								      <div class="controls-wrap">
						...
						'url' =>	'<div class="input-wrap">
								      <label class="control-label" for="url">'. esc_html__( 'Website', 'krea' ) . '</label>
								      <div class="controls-wrap">
