<?php
/**
 * Krea functions and definitions.
 *
...
function krea_setup() {
	...
	define( 'KREA_THEME_NAME', $krea_theme_data['Name'] );
	define( 'KREA_THEME_VERSION', $krea_theme_data['Version'] );

	/*
	 * Make theme available for translation.
	 * Translations can be filed in the /languages/ directory.
	 * If you're building a theme based on Krea, use a find and replace
	 * to change 'krea' to the name of your theme in all the template files.
	 */
	load_theme_textdomain( 'krea', get_template_directory() . '/languages' );
	...
	register_nav_menus( array(
		'primary' => esc_html__( 'Primary Menu', 'krea' ),
		'social' => esc_html__( 'Social Menu', 'krea' ),
	) );
	...
	add_theme_support( 'custom-background', apply_filters( 'krea_custom_background_args', array(
...
add_action( 'after_setup_theme', 'krea_setup' );
 ...
 */
function krea_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'krea_content_width', 1190 );
}
add_action( 'after_setup_theme', 'krea_content_width', 0 );
 ...
 */
function krea_widgets_init() {

	require get_template_directory() . '/inc/widget-areas/widget-areas.php';

}
add_action( 'widgets_init', 'krea_widgets_init' );
...
add_action( 'wp_enqueue_scripts', 'krea_scripts' );
