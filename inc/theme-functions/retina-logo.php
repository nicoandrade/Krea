 ...
 * @since   0.1.0
 */
function krea_custom_logo_image_attributes( $attr, $attachment, $size ) {
...
add_filter( 'wp_get_attachment_image_attributes', 'krea_custom_logo_image_attributes', 10, 3 );
 ...
 * @since   0.1.0
 */
function krea_custom_logo_html( $html ) {
...
add_filter( 'get_custom_logo', 'krea_custom_logo_html' );
 ...
 * @since   0.1.0
 */
function krea_custom_logo_customizer_control( WP_Customize_Manager $wp_customize ) {
    ...
    $wp_customize->add_control( 'custom_logo_is_retina', array(
        ...
        'label' => __( 'Is this image retina-ready?', 'krea' ),
...
add_action( 'customize_register', 'krea_custom_logo_customizer_control', 20 );
 ...
 * @since   0.1.0
 */
function krea_save_logo_sizes( WP_Customize_Setting $setting ) {
...
add_action( 'customize_save_custom_logo', 'krea_save_logo_sizes' );
add_action( 'customize_save_custom_logo_is_retina', 'krea_save_logo_sizes' );
